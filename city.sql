...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2018 at 02:13 PM
...
INSERT INTO `city` (`city_id`, `city_name`, `CountryCode`, `District`, `Population`) VALUES
...
(440, 'Ji-Parana', 'BRA', 'Rondônia', 93346),
...
(1449, 'Reykjavik', 'ISL', 'Hofudborgarsvadi', 109184),
...
(3210, 'Kosice', 'SVK', 'Východne Slovensko', 241874),
(3211, 'Presov', 'SVK', 'Východne Slovensko', 93977),
...
(3346, 'Hradec Kralove', 'CZE', 'Východni Cechy', 98080),
(3347, 'usti nad Labem', 'CZE', 'Severni Cechy', 95491),
(3348, 'Pardubice', 'CZE', 'Východni Cechy', 91309),
...
--
ALTER TABLE `city`
  MODIFY `city_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4080;
COMMIT;
